...
export function GuestsField() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="flex flex-1 cursor-pointer items-center justify-between gap-2 rounded-full px-4 py-2 text-left outline-none transition-colors hover:bg-black/3 focus-visible:ring-2 focus-visible:ring-blue-600">
